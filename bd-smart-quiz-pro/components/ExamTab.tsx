...
const ExamTab: React.FC<ExamTabProps> = ({ user, onSubjectSelect, onLessonSelect, onSubmitDeposit, onSubmitWithdraw }) => {
  ...
  return (
    <div className="bg-slate-50 w-full font-hind overflow-x-hidden flex flex-col pb-32 min-h-screen">
      {/* Header Section */}
                    ...
                    <div className="p-8 pb-4 relative">
                        <div className="flex justify-between items-start mb-4">
                           <div className="min-w-0 pr-8">
                              ...
                              <span className="inline-block text-[9px] font-black text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-md uppercase">{quiz.subject}</span>
                           </div>
                        ...
                        <div className="bg-slate-50/80 rounded-[32px] p-6 grid grid-cols-2 gap-4 border border-slate-100 mb-6">
                           <div className="text-center">
                              ...
                              <span className="text-xl font-black text-emerald-700">৳{quiz.prizePool}</span>
                           </div>
                           <div className="text-center border-l border-slate-200">
                              <p className="text-[9px] font-black text-slate-400 uppercase">এন্ট্রি ফি</p>
                              <span className="text-xl font-black text-slate-800">৳{quiz.entryFee}</span>
                           </div>
                        </div>
                    </div>
